...
public class GedcomlPackageImpl extends EPackageImpl implements GedcomlPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getPerson_Addresses(), this.getAddress(), null, "addresses", null, 1, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
